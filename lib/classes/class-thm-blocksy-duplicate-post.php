...
if( !class_exists( 'Evertheme_Duplicate_Post' ) ):

	class Evertheme_Duplicate_Post {

		function __construct() {
			
			add_filter( 'postmeta_form_keys', [ $this, 'evt_postmeta_form_keys' ], 10, 2 );
			add_action( 'admin_action_duplicate_post_as_draft', [ $this, 'evt_duplicate_post_as_draft' ] );
			add_filter( 'post_row_actions', [ $this, 'evt_duplicate_post_link' ], 10, 2 );
			add_filter( 'page_row_actions', [ $this, 'evt_duplicate_post_link' ], 10, 2 );
		 ...
		 * @return array|null
		 */
		function evt_postmeta_form_keys( $keys, $post ) {
		 ...
		 */
		function evt_duplicate_post_as_draft(){
			global $wpdb;
		 ...
		 */
		function evt_duplicate_post_link( $actions, $post ) {
